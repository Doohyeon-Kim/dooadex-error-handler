...
import 'gazua_errors.dart';

class UserInputError extends GzErrors {
...
class InvalidFormat extends GzErrors {
...
class BadRequest extends GzErrors {
...
class Unauthorized extends GzErrors {
...
class Forbidden extends GzErrors {
...
class NotFound extends GzErrors {
...
class Conflict extends GzErrors {
...
class RequestTimeout extends GzErrors {
...
class InternalServerError extends GzErrors {
  InternalServerError(
...
class ServiceUnavailable extends GzErrors {
  ServiceUnavailable(
      {String? type, String? message, String? title, String? detail})
      : super(
...
class UnknownError extends GzErrors {
...
class UnstableNetwork extends GzErrors {
  UnstableNetwork(
      {String? type, String? message, String? title, String? detail})
      : super(
